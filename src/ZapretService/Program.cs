...
static class Program {
 ...
 static int Main(string[] args){
  try{
   ...
   if(args.Length==1&&args[0]=="--version"){Console.WriteLine("0.1.0");return 0;}
   ...
   if(args.Length==3&&args[0]=="--setup"){Installer.Setup(args[1],args[2]).GetAwaiter().GetResult();return 0;}
